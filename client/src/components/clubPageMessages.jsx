...
export default function ClubPageMessages() {
  const { topFade, botFade, onScroll } = useScrollFades(128);

  return (
    // Parent box
    <div className="z-30 mx-auto h-[120vh] w-[95vw] rounded-xl bg-primary-700 shadow-[0_0_10px_3px_rgba(0,0,0,0.35)]">
      {/* Join Button */}
      ...
      <div className="w-[65vw] ml-auto mr-8">
        ...
        {/* Message Board */}
        <div
          className="z-30 ml-auto mr-8 flex flex-col h-[95vh] w-full bg-primary-50 rounded-xl mt-8 overflow-y-scroll no-scrollbar shadow-[0_0_20px_6px_rgba(0,0,0,0.35)]"
          onScroll={onScroll}
        >
          {/* Top scroll fade */}
          <div
